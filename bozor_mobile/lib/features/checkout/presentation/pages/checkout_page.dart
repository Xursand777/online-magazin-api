                      ...
                      if (isMaster) ...[
                        ...
                        Expanded(
                          child: _PaymentMethodCard(
                            ...
                            onTap: () => setState(() => _paymentMethod = 'installment'),
                          ),
                        ),
                      ],
                    ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                // Agar atributlari bo'lsa shuyerga qo'shish mumkin
                // Text('Oq rang, 128GB', style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.outline)),
                // const SizedBox(height: 4),
                Text(
